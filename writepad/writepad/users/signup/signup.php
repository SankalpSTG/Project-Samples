		...
		<div id="c-container">
			<div id="container-overlay">
				<div id="signin-container">
					...
					<hr>
					<div id="signin-container">
						<h1 style="color:#ccc; font-family:serif">Sign Up</h1>
						<input id="inp-fname" class="wc_input" type="text" name="inp_fname" placeholder="First Name"><br>
						<input id="inp-lname" class="wc_input" type="text" name="inp_lname" placeholder="Last Name"><br>
						<input id="inp-username" class="wc_input" type="text" name="inp_username" placeholder="Username"><br>
						<input id="inp-email" class="wc_input" type="text" name="inp_email" placeholder="Email"><br>
						<input id="inp-dob" class="wc_input" type="date" name="inp_dob" placeholder="Date of Birth"><br>
						<select id="inp-acctype" class="wc_input" name="inp_acctype">
